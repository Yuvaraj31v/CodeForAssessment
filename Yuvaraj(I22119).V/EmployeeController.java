...
/**            
 * <p>
 * EmployeeController class interacts with the user 
 * in getting inputs and showing the required details 
 * </p>
 *
 * @author Yuvaraj
 *
...
public class EmployeeController {
    ...
    public void init() {
        ...
        while (isContinue) {
            try {
                ...
                scanner.next();
                logger.error("Invalid Input please Enter again");
            }
        }
    }
    ...
    /**
     * used to get employeeId from user 
     *
